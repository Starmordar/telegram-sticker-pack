    ...
    return (
      <div className="form-container">
        <header className="form-container__header">
          <h2 className="form-container__header__heading">
        ...
        <form>
          <div className="form-group">
            ...
            />
            <small id="setNameHelp" className="form-text text-muted">
              Can contain only english letters, digits and underscores. Must
              begin with a letter, can't contain consecutive underscores. 1-64
              characters.
            </small>
          </div>
          ...
          <div className="form-group">
            ...
            />
            <small id="setTitleHelp" className="form-text text-muted">
              {" "}
