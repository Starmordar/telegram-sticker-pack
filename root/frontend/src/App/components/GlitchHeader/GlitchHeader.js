  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <h2 className="glitch-header__heading glitch-header__heading-clone font-weight-bold">
          WRONG DATA
        </h2>
        <p className="glitch-header__subheader">
          You trying to log-in with invalid or outdated data. Make sure that you
          are using
          <a
            className="loginbot-link"
            href="tg://resolve?domain=testSamples_bot"
          >
            {" "}
            @login_bot{" "}
          </a>
          for sign-in and try again
        </p>
